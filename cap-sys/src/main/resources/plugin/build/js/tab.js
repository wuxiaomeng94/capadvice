...
layui.define(['jquery', 'element', 'nprogress', 'utils'], function(exports) {
    ...
    var Tab = function() {
        ...
        this.config = {
            ...
            renderType: 'iframe',
            openWait: true,
            firstTitle: adviceTitle,
            firstMenuId: adviceMenuId
        };
        this.v = '1.0.5';
    };
    ...
    var _tab = {
        ...
        createTabDom: function() {
            ...
            var tpl = [
                    ...
                    '<li class="layui-this" lay-id="'+_config.firstMenuId+'" data-url="' + _config.mainUrl + '"><i class="layui-icon">&#xe68e;</i> '+_config.firstTitle+'<!--<i class="layui-icon layui-unselect layui-tab-close">&#x1006;</i>--></li>',
                    '</ul>',
